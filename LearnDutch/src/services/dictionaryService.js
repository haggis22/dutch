(function (app) {
    ...
    app.factory('dutch.dictionaryService', ['dutch.Adjective', 'dutch.Adverb', 'dutch.Noun', 'dutch.Nummer', 'dutch.Phrase', 'dutch.Preposition', 'dutch.Verb', 
            ...
            words.push(new Adjective(3, ['leuk', 'grappig'], 'funny'));
            ...
            words.push(new Noun(14, ['de pont', 'de veerboot'], 'the ferry'));
            ...
            words.push(new Noun(20, ['de kennis', 'de bekende'], 'the acquaintance'));
            ...
            words.push(new Adjective(25, 'enige', 'only (only one)'));
            ...
            words.push(new Noun(27, ['de regio', 'de streek'], 'the region'));
...
//            words.push(new Noun(28, 'de naturalisatie', 'the naturalisation'));
            ...
            words.push(new Adverb(34, ['reeds', 'al', 'nu al', 'alvast', 'alreeds', 'bereids'], 'already'));
            words.push(new Adverb(34, 'net', 'just so (elegantly)'));
            words.push(new Adverb(34, ['pas', 'alleen'], 'only (merely, singly)'));
            ...
            words.push(new Noun(36, 'Sinterklaas', 'Santa Claus'));
            words.push(new Noun(36, 'Zwarte Piet', 'Black Peter'));
